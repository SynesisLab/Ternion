  ...
  return (
    ...
    >
      <div className="flex max-h-[90vh] w-full max-w-lg flex-col rounded-xl border border-[color:var(--color-edge)] bg-[color:var(--color-panel)] p-5 shadow-2xl">
        ...
        {/* Tab content scrolls inside the height-capped dialog — the tab row
            and the save/reset footer stay reachable with long lists (the
            Models tab renders one row per discovered model). */}
